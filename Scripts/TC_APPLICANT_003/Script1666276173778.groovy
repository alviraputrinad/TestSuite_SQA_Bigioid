...
WebUI.setText(findTestObject('Object Repository/Page_Karir Big/input_Email address_email'), 'sabrinagmail.com')

WebUI.setText(findTestObject('Object Repository/Page_Karir Big/input_Phone number_phone'), '08892909802')
...
WebUI.verifyElementAttributeValue(findTestObject('Object Repository/Page_Karir Big/input_Email address_email'), 'value', 'sabrinagmail.com', 20)

WebUI.verifyElementAttributeValue(findTestObject('Object Repository/Page_Karir Big/input_Phone number_phone'), 'value', '08892909802', 20)
