...
WebUI.verifyEqual("Status", driver.findElement(By.xpath("//table/thead/tr/th[4]")).getText())

WebUI.verifyEqual("Actions", driver.findElement(By.xpath("//table/thead/tr/th[5]")).getText())

WebUI.verifyEqual("Detail", driver.findElement(By.xpath("//table/tbody/tr[1]/td[5]/a")).getText())

WebUI.verifyEqual("Proceed", driver.findElement(By.xpath("//table/tbody/tr[1]/td[5]/form/button[1]")).getText())

WebUI.verifyEqual("Delete", driver.findElement(By.xpath("//table/tbody/tr[1]/td[5]/form/button[2]")).getText())
