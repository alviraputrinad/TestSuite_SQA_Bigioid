...
WebUI.sendKeys(findTestObject('Object Repository/Page_Karir Big/input_Password_password'), Keys.chord(Keys.ENTER))
...
WebUI.click(findTestObject('Object Repository/Page_Karir Big/button_Proceed'))
